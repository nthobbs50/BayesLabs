...
idxkeep = sort(sample(1:ntot,round(1*ntot)))
n.adapt=500
n.update=1000
n.iter=1000
...
jm_a=jags.model("AspatialJAGS.R", n.adapt = 10, n.chains = 1, inits=inits, data=data)
#zc_a = coda.samples(jm_a, variable.names=c("beta","sigma"), n.iter=1000)
update(jm_a, n.iter=10)
#Be careful.  It may appear that model is stuck because the *** freeze.  Be patient.
zj_a =jags.samples(jm_a,variable.names=c("beta","sigma","epsilon"), n.iter=10)
...
jm_a2=jags.model("AspatialJAGS.R", n.adapt = 10, n.chains = 1, inits=inits, data=data)
#zc_a = coda.samples(jm_a, variable.names=c("beta","sigma"), n.iter=1000)

update(jm_a2,n.iter=10)

zj_a2 =jags.samples(jm_a2,variable.names=c("beta", "epsilon", "sigma"), n.iter=10)
par(mfrow=c(2,2))
