...
2. For all chains combined, make a histogram of the samples retained after burn-in. Put a vertical line on the plot showing the generating value for the mean and the mean of the data. 
...
abline(v=mean(y),lty = "dashed", col = "red", lwd = 2)
abline(v = theta, lty = "dashed", col = "blue", lwd = 2)
text=c("sample mean", "generating mean")
col=c("red", "blue")
lty=c("dashed", "dashed")
legend(95,.6, text, col=col, lty=lty, lwd=2)
...
hist(pvar[, samplesKept], breaks = 100, freq = FALSE, main = expression(varsigma^2), xlab = "Value of MCMC samples", col = "gray", xlim=c(15,35))
lines(density(pvar[, samplesKept]), col = "red", lwd = 3)
abline(v = varsigma.sq, lty = "dashed", col = "blue", lwd = 2)
abline(v = var(y), lty = "dashed", col = "red", lwd = 2)
text=c("sample variance", "generating variance")
col=c("red", "blue")
lty=c("dashed", "dashed")
legend(26,.12, text, col=col, lty=lty, lwd=2)
```
