...
We run the model in parallel using the code from algorithm 5. We use the ``proc.time`` function to see how long JAGS takes to run the Logistics model in parallel.
...
initsP = list(
  ...
  list(K = 1000, r = .15, sigma = .1,
          .RNG.name = "base::Mersenne-Twister", .RNG.seed = 22),
  list(K = 900, r = .3, sigma = .01,
          .RNG.name = "base::Mersenne-Twister", .RNG.seed = 373))
